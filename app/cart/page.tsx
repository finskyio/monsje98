      ...
      {state.items.length === 0 ? (
        ...
        <div className="space-y-4 max-w-[70%] mx-auto">
          {state.items.map((item) => (
            ...
            >
              ...
              <div className="mt-4 md:mt-0 md:ml-4 flex-1">
                ...
                <p className="bg-gradient-to-r from-[#e5e5e5ae] to-[#f2f2f2a1] rounded-lg p-1 font-medium tracking-tighter text-md mt-2 lg:max-w-[15%] max-w-[35%] mx-auto lg:mx-0 md:mx-0">
          ...
          <div className="flex flex-col md:flex-row justify-between items-center mt-6">
            <p className="bg-gradient-to-r from-[#e5e5e5ae] to-[#f2f2f2a1] rounded-lg p-1 font-medium tracking-tighter text-lg mt-2 lg:max-w-[20%] max-w-[70%] mb-4 lg:mb-0">
              Total: {totalPrice.toFixed(2)} €
            </p>
            <Link href="/checkout">
              <button className="text-md tracking-tight mb-2 bg-gradient-to-r from-[#BFD962] to-[#DEF2B3] rounded-[10px] p-2 text-black/70 hover:bg-gradient-to-r hover:from-[#b6d058] hover:to-[#d1f08e] hover:text-black transition duration-600 ease-in-out">
                Proceed to Checkout
              </button>
            </Link>
          </div>
