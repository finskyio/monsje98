        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mx-auto">
          <div className="flex flex-col items-center md:items-start">
            ...
            <motion.p
              ...
              transition={{ duration: 0.6, delay: 0.2 }}
            >
              At Monsjé SPA, every treatment is a journey into deep relaxation and rejuvenation, inspired by the purity of nature. Our therapies are crafted using only{' '}
              <span className="bg-gradient-to-r from-[#BFD962] to-[#f2f2f2a1] rounded-lg p-1">
                ingredients grown in our ecological gardens
              </span>
              , where each plant is nurtured and harvested in harmony with its natural cycle. From the hydrating power of Rosa damascena to the detoxifying properties of white tea, our rituals invite you to experience true serenity while enhancing your natural beauty.
            </motion.p>
          </div>
          <div>
            <motion.div
